...
public final class SubstanceFactory {
    ...
    public static Refrigerant createRefrigerant(SubstanceName substanceName, SubstanceParameter parameter1, SubstanceParameter parameter2) {
        return createRefrigerant(substanceName, parameter1.getType(), parameter1.getValue(), parameter2.getType(), parameter2.getValue());
    }

    public static Refrigerant createRefrigerant(SubstanceName substanceName, SubstanceParameterType parameter1, double value1, SubstanceParameterType parameter2, double value2) {
        Substance refrigerantGeneral = createGeneral(substanceName, parameter1, value1, parameter2, value2);
        Refrigerant refrigerant = new Refrigerant();
        refrigerant.substanceName = refrigerantGeneral.substanceName;
        ...
        refrigerant.temperatureSaturation.value = ThermoCPAdapter.findParameter(SubstanceParameterType.TEMPERATURE,substanceName,SubstanceParameterType.PRESSURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,0.5);
        refrigerant.pressureSaturation.value = ThermoCPAdapter.findParameter(SubstanceParameterType.PRESSURE,substanceName,SubstanceParameterType.TEMPERATURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,0.5);
        refrigerant.temperatureBubbles.value = ThermoCPAdapter.findParameter(SubstanceParameterType.TEMPERATURE,substanceName,SubstanceParameterType.PRESSURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,0);
        refrigerant.pressureBubbles.value = ThermoCPAdapter.findParameter(SubstanceParameterType.PRESSURE,substanceName,SubstanceParameterType.TEMPERATURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,0);
        refrigerant.temperatureDew.value = ThermoCPAdapter.findParameter(SubstanceParameterType.TEMPERATURE,substanceName,SubstanceParameterType.PRESSURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,1);
        refrigerant.pressureDew.value = ThermoCPAdapter.findParameter(SubstanceParameterType.PRESSURE,substanceName,SubstanceParameterType.TEMPERATURE,refrigerant.pressure.value,SubstanceParameterType.QUALITY,1);
