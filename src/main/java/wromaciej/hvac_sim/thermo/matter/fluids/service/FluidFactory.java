...
public final class FluidFactory {
    ...
    public static Air createAir(FluidParameter parameter1, FluidParameter parameter2){
        return createAir(parameter1, parameter2, UnitSystem.getActualUnitSystem().getAtmosphericPressure());

    }

    public static Air createAir(FluidParameter<? extends AirQuantity> parameter1, FluidParameter parameter2, Parameter<Pressure> absolutePressure){
        Air air= new Air();
        air.setFluidName(FluidName.AIR);
